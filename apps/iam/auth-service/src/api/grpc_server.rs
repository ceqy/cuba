...
impl AuthService for AuthServiceImpl {
    async fn register(&self, request: Request<RegisterRequest>) -> Result<Response<RegisterResponse>, Status> {
        ...
        match self.register_handler.handle(req.username, req.email, req.password, req.tenant_id).await {
    ...
    async fn get_current_user(&self, request: Request<()>) -> Result<Response<GetCurrentUserResponse>, Status> {
        ...
        match self.user_repository.find_by_id(&user_id_string).await {
            Ok(Some(user)) => {
                let roles = user.roles.iter().map(|r: &String| common_proto::Role {
    ...
    async fn change_password(&self, _request: Request<ChangePasswordRequest>) -> Result<Response<ChangePasswordResponse>, Status> { Err(Status::unimplemented("")) }
    async fn update_profile(&self, _request: Request<UpdateProfileRequest>) -> Result<Response<UpdateProfileResponse>, Status> { Err(Status::unimplemented("")) }
    async fn enable2_fa(&self, _request: Request<()>) -> Result<Response<Enable2FaResponse>, Status> { Err(Status::unimplemented("")) }
    async fn verify2_fa(&self, _request: Request<Verify2FaRequest>) -> Result<Response<Verify2FaResponse>, Status> { Err(Status::unimplemented("")) }
    async fn verify2_fa_code(&self, _request: Request<Verify2FaCodeRequest>) -> Result<Response<LoginResponse>, Status> { Err(Status::unimplemented("")) }
    async fn get_audit_logs(&self, _request: Request<GetAuditLogsRequest>) -> Result<Response<GetAuditLogsResponse>, Status> { Err(Status::unimplemented("")) }
    async fn list_user_sessions(&self, _request: Request<ListUserSessionsRequest>) -> Result<Response<ListUserSessionsResponse>, Status> { Err(Status::unimplemented("")) }
    async fn revoke_session(&self, _request: Request<RevokeSessionRequest>) -> Result<Response<RevokeSessionResponse>, Status> { Err(Status::unimplemented("")) }
    async fn get_perm_codes(&self, _request: Request<()>) -> Result<Response<GetPermCodesResponse>, Status> { 
